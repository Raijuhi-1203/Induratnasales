...
{
    public static void SetCustomerSessions(Context context, SalesPersonModel customers) {
        Gson gson = new Gson();
        String json = gson.toJson(customers);
        setSharedPreferenceString(context, "login", json);
    }

    public static SalesPersonModel getCurrentUser(Context context) {
        SalesPersonModel customers=null;
        Gson gson = new Gson();
        String json = getSharedPreferenceString(context, "login", null);
        if (json != null)
            customers = gson.fromJson(json, SalesPersonModel.class);
        return customers;
    }
