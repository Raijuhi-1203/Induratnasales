...
import codesgesture.app.induratnasales.Adapter.PaymentShopAdapter;
...
public class ShopPayment extends AppCompatActivity {
    ...
    PaymentShopAdapter productAdapter;
    TextView credit,acnm,fnm,mob;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payment_list_shop);
        ...
        title.setText("Shopwise Payment");
        ...
        shopModelArrayAdapter = new ArrayAdapter<ShopModel>(ShopPayment.this, android.R.layout.simple_spinner_item, shopModels);
        ...
        GridLayoutManager mLayoutManager = new GridLayoutManager(ShopPayment.this, 1);
        recyclerView.setLayoutManager(mLayoutManager);
        productAdapter = new PaymentShopAdapter(ShopPayment.this, productModels, R.layout.item_payment_shop);
        ...
        datepickerto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ShopPayment.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void Bindata(String buyerid) {
        ...
        CallJson jc = new CallJson(ShopPayment.this);
        ...
        jc.SendRequest(s,"shop_payment", param, new JsonCallbacks() {
            @Override
